...
$res = [
    'connections' => [
        ...
        'user' => [
            ...
            'port' => env('DB_PORT', '3306'),
            // 'unix_socket' => '/Applications/MAMP/tmp/mysql/mysql.sock',
            'database' => env('DB_DATABASE_BROKER_USER', 'forge86'),
            'username' => env('DB_USERNAME_BROKER_USER', 'forge_user_02_1'),
            'password' => env('DB_PASSWORD_BROKER_USER', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'foreign_key_constraints' => env('DB_FOREIGN_KEYS', true),
        ...
        'user_sqlite' => [
            'driver' => env('DB_CONNECTION', 'mysql'),
            'url' => env('DATABASE_URL'),
            'database' => database_path(env('DB_DATABASE_BROKER_USER', 'broker_user').'.sqlite'),
            'prefix' => '',
            'foreign_key_constraints' => env('DB_FOREIGN_KEYS', true),
        ],
        */
        ...
        'brain' => [
            ...
            'port' => env('DB_PORT', '3306'),
            'database' => 'braindb',
            'username' => env('DB_USERNAME_BROKER', 'forge_mysql_25_1'),
            'password' => env('DB_PASSWORD_BROKER', ''),
            // 'unix_socket' => '/Applications/MAMP/tmp/mysql/mysql.sock',
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
