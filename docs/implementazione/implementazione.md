# Guida all'Implementazione di SaluteOra

## Panoramica del Progetto

SaluteOra è un sistema di gestione per il progetto "Promozione della salute orale per le gestanti in condizioni di vulnerabilità socio-economica". Il sistema è costruito utilizzando:
...
**IMPORTANTE**: In SaluteOra, tutte le migrazioni sono gestite all'interno dei moduli Laraxot. Prima di eseguire le migrazioni, è necessario rimuovere le migrazioni locali:
...
Per supporto tecnico sul progetto SaluteOra, contattare:
