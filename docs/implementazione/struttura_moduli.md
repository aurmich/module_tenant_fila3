...
1. **Namespace**: Ogni modulo deve utilizzare il namespace base `Modules\{ModuleName}`. I sottonamespace devono essere aggiunti dopo il nome del modulo:
   ```php
   namespace Modules\Dental;                    // Namespace base
   namespace Modules\Dental\Models;             // Per i modelli
   namespace Modules\Dental\Http\Controllers;    // Per i controller
   namespace Modules\Dental\Filament\Resources; // Per le risorse Filament
   ```
...
6. **Traduzioni**: Le traduzioni devono essere in `Modules/{ModuleName}/resources/lang/`
