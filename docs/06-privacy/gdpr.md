# Conformità GDPR per SaluteOra

## Panoramica

Il progetto SaluteOra tratta dati personali e sanitari di gestanti in condizioni di vulnerabilità socio-economica, pertanto la conformità al GDPR è un requisito fondamentale. Questo documento descrive le misure implementate per garantire la conformità normativa.
...
Una DPIA completa è stata condotta per il progetto SaluteOra, identificando:
