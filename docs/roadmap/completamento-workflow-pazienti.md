...
Il completamento del workflow pazienti è attualmente implementato all'85%. Questo componente è fondamentale per gestire l'intero ciclo di vita del paziente all'interno della piattaforma SaluteOra, dalla registrazione alla gestione appuntamenti e trattamenti.
