...
Il frontend del progetto SaluteOra deve essere implementato seguendo il design presentato nel documento di progetto, con particolare attenzione ai flussi utente per pazienti, odontoiatri e personale di back office.
...
1. **Creare layout principale**:
   ...
   <head>
       ...
       <title>SaluteOra - @yield('title')</title>
       ...
       <header class="bg-white shadow">
           <div class="container mx-auto px-4 py-6">
               <div class="flex justify-between items-center">
                   <img src="{{ asset('images/logo.png') }}" alt="SaluteOra" class="h-16">
                   <nav>
