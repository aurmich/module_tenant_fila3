...
L'integrazione del sistema ISEE all'interno della piattaforma SaluteOra è attualmente implementata al 60%. Il sistema permette la verifica dell'idoneità delle pazienti al programma sulla base del valore ISEE e dello stato di gravidanza.
