...
Il modulo Patient è una componente fondamentale del progetto SaluteOra, incaricato di gestire tutte le informazioni relative alle pazienti gestanti che partecipano al programma. Questo modulo deve garantire:
