...
Creare un ambiente Docker completo con tutti i servizi necessari per SaluteOra:
...
## Descrizione
SaluteOra è un sistema di gestione per il progetto "Promozione della salute orale per le gestanti in condizioni di vulnerabilità socio-economica".
