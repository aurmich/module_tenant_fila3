...
Il CMS per contenuti informativi ed educativi è attualmente completato al 20%. Questo componente è fondamentale per gestire e presentare i contenuti di carattere informativo, educativo e divulgativo all'interno della piattaforma SaluteOra, offrendo risorse utili sia ai pazienti che agli operatori sanitari.
