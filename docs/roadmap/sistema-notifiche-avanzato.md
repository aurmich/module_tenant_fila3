...
Il sistema di notifiche avanzato con templates personalizzabili è attualmente completato al 30%. Questo componente estende le funzionalità del sistema notifiche multi-canale base, implementando un'architettura flessibile per la gestione di tutte le comunicazioni generate dalla piattaforma SaluteOra.
