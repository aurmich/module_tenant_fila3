...
La conformità al GDPR è un requisito fondamentale del sistema SaluteOra. Implementeremo un modulo GDPR completo che fornirà tutte le funzionalità necessarie per garantire la protezione dei dati personali e sensibili.
