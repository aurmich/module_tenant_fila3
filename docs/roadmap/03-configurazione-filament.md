# Configurazione Filament per SaluteOra
...
2. Ci sono incompatibilità di versione tra i moduli e Filament 3.x
...
1. **Aggiornare composer.json** con le dipendenze di Filament 3.x:
...
1. Un sistema Filament 3.x funzionante con supporto multi-tenant
...
5. Una base solida per lo sviluppo delle funzionalità specifiche di SaluteOra 