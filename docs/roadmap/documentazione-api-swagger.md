...
La documentazione delle API tramite Swagger/OpenAPI è attualmente completata al 30%. Questa componente è fondamentale per fornire una documentazione interattiva e aggiornata automaticamente delle API RESTful di SaluteOra.
...
info:
  title: SaluteOra API
  description: API per accesso e gestione dati piattaforma SaluteOra
  version: 1.0.0
servers:
