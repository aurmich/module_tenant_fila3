...
Il sistema Activity avanzato con audit trail completo è attualmente completato al 20%. Questo componente è fondamentale per garantire la tracciabilità di tutte le operazioni effettuate sulla piattaforma SaluteOra, con particolare attenzione ai dati sensibili e ai processi clinici.
