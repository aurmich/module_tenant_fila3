# Roadmap Progetto SaluteOra (Aggiornata)
...
- [Configurazione Filament](03-configurazione-filament.md) - Implementazione del pannello amministrativo con Filament 3.x
...
3. **Aggiornamento delle dipendenze e configurazione**
   - Aggiornamento di composer.json con dipendenze Filament 3.x
...
5. **UI** ✅ - Completato (da aggiornare a Filament 3.x)
