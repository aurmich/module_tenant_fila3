...
Il progetto SaluteOra, trattando dati sensibili di pazienti gestanti in condizione di vulnerabilità socio-economica, richiede un'attenta implementazione delle misure di sicurezza e conformità al GDPR. Il modulo GDPR è stato installato ma necessita di configurazione specifica.
...
- Configurazione consensi specifici per SaluteOra
