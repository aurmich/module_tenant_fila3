...
class AppointmentRequests extends Component
{
    ...
    public function acceptedAppointmentsAction(): Action
    {
        return Action::make('acceptedAppointments')
    ...
    public function rejectedAppointmentsAction(): Action
    {
        return Action::make('rejectedAppointments')
