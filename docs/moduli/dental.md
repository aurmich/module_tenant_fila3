...
## Descrizione
Il modulo Dental è il cuore del sistema SaluteOra, responsabile della gestione completa delle visite odontoiatriche, dei trattamenti e della documentazione clinica. Questo modulo si integra con il modulo Patient per fornire una gestione completa del percorso clinico del paziente.
