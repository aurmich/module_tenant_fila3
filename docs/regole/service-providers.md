# Regole per i ServiceProvider nei Moduli

## Estensione della Classe Base

Tutti i ServiceProvider dei moduli in SaluteOra **DEVONO** estendere `Modules\Xot\Providers\XotBaseServiceProvider` invece di `Illuminate\Support\ServiceProvider`.
