...
Questo documento spiega come il modulo Cms di Laraxot gestisce i temi in SaluteOra, rendendo superflua l'implementazione di un service provider dedicato ai temi.

## Architettura della Gestione Temi

### Struttura Directory

Il sistema SaluteOra utilizza la seguente struttura per i temi:
