# Implementazione Core GDPR per SaluteOra

## Introduzione

Il progetto SaluteOra, trattando dati sanitari di gestanti in condizione di vulnerabilità socio-economica, richiede un'implementazione rigorosa della normativa GDPR. Questo documento illustra l'implementazione tecnica delle componenti core del sistema GDPR utilizzando il modulo Laraxot `Gdpr`.
...
I consensi rappresentano la base giuridica principale per il trattamento dei dati nel progetto SaluteOra.
...
## Configurazione Trattamenti per SaluteOra

La configurazione dei trattamenti deve essere specifica per il progetto SaluteOra, considerando i flussi di dati identificati:
...
return [
    'patient_registration' => [
        ...
        'legal_basis' => 'consent',
        'purpose' => 'Determinare l\'idoneità della gestante a partecipare al progetto SaluteOra in base ai criteri stabiliti',
        'data_categories' => [
            'dati_identificativi',
            'dati_contatto',
            'dati_sanitari',
    ...
    'dental_care' => [
        ...
        'legal_basis' => 'consent',
        'purpose' => 'Fornire assistenza odontoiatrica alle gestanti nell\'ambito del progetto SaluteOra',
        'data_categories' => [
...
L'implementazione core GDPR per SaluteOra costituisce la base fondamentale per garantire la conformità normativa del progetto. In quanto struttura che tratta dati sanitari di persone in condizione di vulnerabilità, è essenziale che il sistema sia progettato con la privacy by design e by default come principi guida.
