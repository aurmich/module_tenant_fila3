...
## Panoramica
L'architettura base di Filament in SaluteOra è costruita su un sistema modulare che utilizza classi base astratte per fornire funzionalità comuni e standardizzare l'implementazione.
