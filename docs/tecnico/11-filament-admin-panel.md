...
## Descrizione
Il `AdminPanelProvider` è un componente fondamentale per la configurazione del pannello amministrativo di Filament in SaluteOra. Questo provider estende `XotBaseMainPanelProvider` e personalizza il comportamento del pannello amministrativo.
