...
Questo documento riassume le principali leggi di UX basate sul sito [Laws of UX](https://lawsofux.com/) e spiega come applicarle al progetto SaluteOra. L'obiettivo è migliorare l'esperienza utente dell'applicazione seguendo principi consolidati di design e psicologia cognitiva.
...
Per implementare efficacemente queste leggi di UX nel progetto SaluteOra, seguire queste linee guida:
