# Gestione delle Route con Laravel Folio in SaluteOra
...
4. [Implementazione in SaluteOra](#implementazione-in-saluteora)
5. [Esempi Pratici](#esempi-pratici)
6. [Errori Comuni e Best Practices](#errori-comuni-e-best-practices)

## Introduzione

Questo documento descrive come vengono gestite le route in SaluteOra utilizzando Laravel Folio, con particolare attenzione all'uso delle named routes e alla funzione `route()` per generare URL.
...
In SaluteOra, tutte le pagine principali del frontoffice utilizzano named routes definite nei file Folio. Ecco come sono implementate:
