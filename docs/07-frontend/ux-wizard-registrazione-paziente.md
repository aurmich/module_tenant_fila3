...
Questo documento illustra come le leggi di UX del sito [Laws of UX](https://lawsofux.com/) sono state applicate specificamente al wizard di registrazione paziente nel progetto SaluteOra.
...
- [Documenti di progettazione SaluteOra](/docs/07-frontend/leggi-ux.md)
