# Struttura delle Route e Viste in SaluteOra
...
Questo documento descrive la struttura delle route e delle viste nel progetto SaluteOra, con particolare attenzione alla relazione tra URL, route e file di vista. Comprende anche una guida per identificare correttamente i file corrispondenti a specifiche route.

## Stack Tecnologico

SaluteOra utilizza un mix di tecnologie moderne per il frontend e il backend:
...
Le viste in SaluteOra sono organizzate principalmente in due aree:
...
In SaluteOra, gli URL seguono questa struttura:
...
**Problema**: SaluteOra può supportare più temi, e le viste possono essere in temi diversi.
