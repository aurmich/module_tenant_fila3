# Script Bash per l'Automazione del Progetto SaluteOra

Questa documentazione descrive gli script bash utilizzati per automatizzare vari aspetti del progetto SaluteOra, facilitando il processo di sviluppo, configurazione e manutenzione.
...
Oltre agli script standard di Laraxot, sono stati sviluppati script personalizzati specifici per il progetto SaluteOra.
...
Gli script bash sono parte integrante del processo di sviluppo e manutenzione del progetto SaluteOra:
