# Architettura Tecnologica SaluteOra

## Stack Tecnologico

SaluteOra è sviluppato seguendo un'architettura moderna e modulare, con una netta separazione tra backend e frontend, ciascuno con il proprio specifico stack tecnologico.
